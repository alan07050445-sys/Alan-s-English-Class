...
const CACHE = 'alans-english-v443';
...
// 跟版本走的檔案：URL 上都帶 ?v=443，所以 cache-first 是安全的（改版就換 URL）。
const PRECACHE = [
  asset('/'), asset('/index.html'), asset('/manifest.json?v=443'),
  asset('/styles.css?v=443'), asset('/styles-part2.css?v=443'), asset('/styles-quiz.css?v=443'),
  asset('/styles-flashcard.css?v=443'), asset('/styles-auth.css?v=443'), asset('/styles-quiz-mode.css?v=443'),
  asset('/data.js?v=443'), asset('/data-g1.js?v=443'), asset('/data-g2.js?v=443'), asset('/data-g4.js?v=443'), asset('/data-g5.js?v=443'), asset('/data-g6.js?v=443'), asset('/data-summer.js?v=443'), asset('/data-grammar.js?v=443'),
  asset('/components-shell.jsx?v=443'), asset('/components-quiz.jsx?v=443'),
  asset('/components-flashcard.jsx?v=443'), asset('/components-editor.jsx?v=443'),
  asset('/components-quiz-mode.jsx?v=443'), asset('/components-dashboard.jsx?v=443'),
  asset('/components-mistakes.jsx?v=443'), asset('/styles-mistakes.css?v=443'),
  asset('/styles-theme.css?v=443'), asset('/styles-home.css?v=443'),
  asset('/app.jsx?v=443'), asset('/components-fx.jsx?v=443'),
  asset('/styles-fx.css?v=443'), asset('/styles-tune.css?v=443'),
  asset('/summer-booking.html'), asset('/summer-booking.css?v=443'), asset('/summer-booking-admin.css?v=443'), asset('/summer-booking.js?v=443'),
];
