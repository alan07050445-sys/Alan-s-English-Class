...
const CACHE = 'alans-english-v427';
...
// 跟版本走的檔案：URL 上都帶 ?v=427，所以 cache-first 是安全的（改版就換 URL）。
const PRECACHE = [
  asset('/'), asset('/index.html'), asset('/manifest.json?v=427'),
  asset('/styles.css?v=427'), asset('/styles-part2.css?v=427'), asset('/styles-quiz.css?v=427'),
  asset('/styles-flashcard.css?v=427'), asset('/styles-auth.css?v=427'), asset('/styles-quiz-mode.css?v=427'),
  asset('/data.js?v=427'), asset('/data-g1.js?v=427'), asset('/data-g2.js?v=427'), asset('/data-g4.js?v=427'), asset('/data-g5.js?v=427'), asset('/data-g6.js?v=427'), asset('/data-summer.js?v=427'), asset('/data-grammar.js?v=427'),
  asset('/components-shell.jsx?v=427'), asset('/components-quiz.jsx?v=427'),
  asset('/components-flashcard.jsx?v=427'), asset('/components-editor.jsx?v=427'),
  asset('/components-quiz-mode.jsx?v=427'), asset('/components-dashboard.jsx?v=427'),
  asset('/components-mistakes.jsx?v=427'), asset('/styles-mistakes.css?v=427'),
  asset('/styles-theme.css?v=427'), asset('/styles-home.css?v=427'),
  asset('/app.jsx?v=427'), asset('/components-fx.jsx?v=427'),
  asset('/styles-fx.css?v=427'), asset('/styles-tune.css?v=427'),
  asset('/summer-booking.html'), asset('/summer-booking.css?v=427'), asset('/summer-booking-admin.css?v=427'), asset('/summer-booking.js?v=427'),
];
