...
const CACHE = 'alans-english-v401';
...
// 跟版本走的檔案：URL 上都帶 ?v=401，所以 cache-first 是安全的（改版就換 URL）。
const PRECACHE = [
  asset('/'), asset('/index.html'), asset('/manifest.json?v=401'),
  asset('/styles.css?v=401'), asset('/styles-part2.css?v=401'), asset('/styles-quiz.css?v=401'),
  asset('/styles-flashcard.css?v=401'), asset('/styles-auth.css?v=401'), asset('/styles-quiz-mode.css?v=401'),
  asset('/data.js?v=401'), asset('/data-g1.js?v=401'), asset('/data-g2.js?v=401'), asset('/data-g4.js?v=401'), asset('/data-g5.js?v=401'), asset('/data-g6.js?v=401'), asset('/data-summer.js?v=401'), asset('/data-grammar.js?v=401'),
  asset('/components-shell.jsx?v=401'), asset('/components-quiz.jsx?v=401'),
  asset('/components-flashcard.jsx?v=401'), asset('/components-editor.jsx?v=401'),
  asset('/components-quiz-mode.jsx?v=401'), asset('/components-dashboard.jsx?v=401'),
  asset('/components-mistakes.jsx?v=401'), asset('/styles-mistakes.css?v=401'),
  asset('/styles-theme.css?v=401'), asset('/styles-home.css?v=401'),
  asset('/app.jsx?v=401'), asset('/components-fx.jsx?v=401'),
  asset('/styles-fx.css?v=401'), asset('/styles-tune.css?v=401'),
  asset('/summer-booking.html'), asset('/summer-booking.css?v=401'), asset('/summer-booking-admin.css?v=401'), asset('/summer-booking.js?v=401'),
];
