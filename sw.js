...
const CACHE = 'alans-english-v408';
...
// 跟版本走的檔案：URL 上都帶 ?v=408，所以 cache-first 是安全的（改版就換 URL）。
const PRECACHE = [
  asset('/'), asset('/index.html'), asset('/manifest.json?v=408'),
  asset('/styles.css?v=408'), asset('/styles-part2.css?v=408'), asset('/styles-quiz.css?v=408'),
  asset('/styles-flashcard.css?v=408'), asset('/styles-auth.css?v=408'), asset('/styles-quiz-mode.css?v=408'),
  asset('/data.js?v=408'), asset('/data-g1.js?v=408'), asset('/data-g2.js?v=408'), asset('/data-g4.js?v=408'), asset('/data-g5.js?v=408'), asset('/data-g6.js?v=408'), asset('/data-summer.js?v=408'), asset('/data-grammar.js?v=408'),
  asset('/components-shell.jsx?v=408'), asset('/components-quiz.jsx?v=408'),
  asset('/components-flashcard.jsx?v=408'), asset('/components-editor.jsx?v=408'),
  asset('/components-quiz-mode.jsx?v=408'), asset('/components-dashboard.jsx?v=408'),
  asset('/components-mistakes.jsx?v=408'), asset('/styles-mistakes.css?v=408'),
  asset('/styles-theme.css?v=408'), asset('/styles-home.css?v=408'),
  asset('/app.jsx?v=408'), asset('/components-fx.jsx?v=408'),
  asset('/styles-fx.css?v=408'), asset('/styles-tune.css?v=408'),
  asset('/summer-booking.html'), asset('/summer-booking.css?v=408'), asset('/summer-booking-admin.css?v=408'), asset('/summer-booking.js?v=408'),
];
