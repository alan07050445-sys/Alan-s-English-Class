...
const CACHE = 'alans-english-v426';
...
// 跟版本走的檔案：URL 上都帶 ?v=426，所以 cache-first 是安全的（改版就換 URL）。
const PRECACHE = [
  asset('/'), asset('/index.html'), asset('/manifest.json?v=426'),
  asset('/styles.css?v=426'), asset('/styles-part2.css?v=426'), asset('/styles-quiz.css?v=426'),
  asset('/styles-flashcard.css?v=426'), asset('/styles-auth.css?v=426'), asset('/styles-quiz-mode.css?v=426'),
  asset('/data.js?v=426'), asset('/data-g1.js?v=426'), asset('/data-g2.js?v=426'), asset('/data-g4.js?v=426'), asset('/data-g5.js?v=426'), asset('/data-g6.js?v=426'), asset('/data-summer.js?v=426'), asset('/data-grammar.js?v=426'),
  asset('/components-shell.jsx?v=426'), asset('/components-quiz.jsx?v=426'),
  asset('/components-flashcard.jsx?v=426'), asset('/components-editor.jsx?v=426'),
  asset('/components-quiz-mode.jsx?v=426'), asset('/components-dashboard.jsx?v=426'),
  asset('/components-mistakes.jsx?v=426'), asset('/styles-mistakes.css?v=426'),
  asset('/styles-theme.css?v=426'), asset('/styles-home.css?v=426'),
  asset('/app.jsx?v=426'), asset('/components-fx.jsx?v=426'),
  asset('/styles-fx.css?v=426'), asset('/styles-tune.css?v=426'),
  asset('/summer-booking.html'), asset('/summer-booking.css?v=426'), asset('/summer-booking-admin.css?v=426'), asset('/summer-booking.js?v=426'),
];
