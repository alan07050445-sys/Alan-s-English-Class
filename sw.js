...
const CACHE = 'alans-english-v414';
...
// 跟版本走的檔案：URL 上都帶 ?v=414，所以 cache-first 是安全的（改版就換 URL）。
const PRECACHE = [
  asset('/'), asset('/index.html'), asset('/manifest.json?v=414'),
  asset('/styles.css?v=414'), asset('/styles-part2.css?v=414'), asset('/styles-quiz.css?v=414'),
  asset('/styles-flashcard.css?v=414'), asset('/styles-auth.css?v=414'), asset('/styles-quiz-mode.css?v=414'),
  asset('/data.js?v=414'), asset('/data-g1.js?v=414'), asset('/data-g2.js?v=414'), asset('/data-g4.js?v=414'), asset('/data-g5.js?v=414'), asset('/data-g6.js?v=414'), asset('/data-summer.js?v=414'), asset('/data-grammar.js?v=414'),
  asset('/components-shell.jsx?v=414'), asset('/components-quiz.jsx?v=414'),
  asset('/components-flashcard.jsx?v=414'), asset('/components-editor.jsx?v=414'),
  asset('/components-quiz-mode.jsx?v=414'), asset('/components-dashboard.jsx?v=414'),
  asset('/components-mistakes.jsx?v=414'), asset('/styles-mistakes.css?v=414'),
  asset('/styles-theme.css?v=414'), asset('/styles-home.css?v=414'),
  asset('/app.jsx?v=414'), asset('/components-fx.jsx?v=414'),
  asset('/styles-fx.css?v=414'), asset('/styles-tune.css?v=414'),
  asset('/summer-booking.html'), asset('/summer-booking.css?v=414'), asset('/summer-booking-admin.css?v=414'), asset('/summer-booking.js?v=414'),
];
