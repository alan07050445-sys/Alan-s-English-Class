...
const CACHE = 'alans-english-v433';
...
// 跟版本走的檔案：URL 上都帶 ?v=433，所以 cache-first 是安全的（改版就換 URL）。
const PRECACHE = [
  asset('/'), asset('/index.html'), asset('/manifest.json?v=433'),
  asset('/styles.css?v=433'), asset('/styles-part2.css?v=433'), asset('/styles-quiz.css?v=433'),
  asset('/styles-flashcard.css?v=433'), asset('/styles-auth.css?v=433'), asset('/styles-quiz-mode.css?v=433'),
  asset('/data.js?v=433'), asset('/data-g1.js?v=433'), asset('/data-g2.js?v=433'), asset('/data-g4.js?v=433'), asset('/data-g5.js?v=433'), asset('/data-g6.js?v=433'), asset('/data-summer.js?v=433'), asset('/data-grammar.js?v=433'),
  asset('/components-shell.jsx?v=433'), asset('/components-quiz.jsx?v=433'),
  asset('/components-flashcard.jsx?v=433'), asset('/components-editor.jsx?v=433'),
  asset('/components-quiz-mode.jsx?v=433'), asset('/components-dashboard.jsx?v=433'),
  asset('/components-mistakes.jsx?v=433'), asset('/styles-mistakes.css?v=433'),
  asset('/styles-theme.css?v=433'), asset('/styles-home.css?v=433'),
  asset('/app.jsx?v=433'), asset('/components-fx.jsx?v=433'),
  asset('/styles-fx.css?v=433'), asset('/styles-tune.css?v=433'),
  asset('/summer-booking.html'), asset('/summer-booking.css?v=433'), asset('/summer-booking-admin.css?v=433'), asset('/summer-booking.js?v=433'),
];
