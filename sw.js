...
const CACHE = 'alans-english-v395';
...
// 跟版本走的檔案：URL 上都帶 ?v=395，所以 cache-first 是安全的（改版就換 URL）。
const PRECACHE = [
  asset('/'), asset('/index.html'), asset('/manifest.json?v=395'),
  asset('/styles.css?v=395'), asset('/styles-part2.css?v=395'), asset('/styles-quiz.css?v=395'),
  asset('/styles-flashcard.css?v=395'), asset('/styles-auth.css?v=395'), asset('/styles-quiz-mode.css?v=395'),
  asset('/data.js?v=395'), asset('/data-g2.js?v=395'), asset('/data-g4.js?v=395'), asset('/data-g5.js?v=395'), asset('/data-g6.js?v=395'), asset('/data-summer.js?v=395'), asset('/data-grammar.js?v=395'),
  asset('/components-shell.jsx?v=395'), asset('/components-quiz.jsx?v=395'),
  asset('/components-flashcard.jsx?v=395'), asset('/components-editor.jsx?v=395'),
  asset('/components-quiz-mode.jsx?v=395'), asset('/components-dashboard.jsx?v=395'),
  asset('/components-mistakes.jsx?v=395'), asset('/styles-mistakes.css?v=395'),
  asset('/styles-theme.css?v=395'), asset('/styles-home.css?v=395'),
  asset('/app.jsx?v=395'), asset('/components-fx.jsx?v=395'),
  asset('/styles-fx.css?v=395'), asset('/styles-tune.css?v=395'),
  asset('/summer-booking.html'), asset('/summer-booking.css?v=395'), asset('/summer-booking-admin.css?v=395'), asset('/summer-booking.js?v=395'),
];
