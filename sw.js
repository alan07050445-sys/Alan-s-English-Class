...
const CACHE = 'alans-english-v396';
...
// 跟版本走的檔案：URL 上都帶 ?v=396，所以 cache-first 是安全的（改版就換 URL）。
const PRECACHE = [
  asset('/'), asset('/index.html'), asset('/manifest.json?v=396'),
  asset('/styles.css?v=396'), asset('/styles-part2.css?v=396'), asset('/styles-quiz.css?v=396'),
  asset('/styles-flashcard.css?v=396'), asset('/styles-auth.css?v=396'), asset('/styles-quiz-mode.css?v=396'),
  asset('/data.js?v=396'), asset('/data-g2.js?v=396'), asset('/data-g4.js?v=396'), asset('/data-g5.js?v=396'), asset('/data-g6.js?v=396'), asset('/data-summer.js?v=396'), asset('/data-grammar.js?v=396'),
  asset('/components-shell.jsx?v=396'), asset('/components-quiz.jsx?v=396'),
  asset('/components-flashcard.jsx?v=396'), asset('/components-editor.jsx?v=396'),
  asset('/components-quiz-mode.jsx?v=396'), asset('/components-dashboard.jsx?v=396'),
  asset('/components-mistakes.jsx?v=396'), asset('/styles-mistakes.css?v=396'),
  asset('/styles-theme.css?v=396'), asset('/styles-home.css?v=396'),
  asset('/app.jsx?v=396'), asset('/components-fx.jsx?v=396'),
  asset('/styles-fx.css?v=396'), asset('/styles-tune.css?v=396'),
  asset('/summer-booking.html'), asset('/summer-booking.css?v=396'), asset('/summer-booking-admin.css?v=396'), asset('/summer-booking.js?v=396'),
];
