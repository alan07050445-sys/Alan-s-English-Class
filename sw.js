...
const CACHE = 'alans-english-v437';
...
// 跟版本走的檔案：URL 上都帶 ?v=437，所以 cache-first 是安全的（改版就換 URL）。
const PRECACHE = [
  asset('/'), asset('/index.html'), asset('/manifest.json?v=437'),
  asset('/styles.css?v=437'), asset('/styles-part2.css?v=437'), asset('/styles-quiz.css?v=437'),
  asset('/styles-flashcard.css?v=437'), asset('/styles-auth.css?v=437'), asset('/styles-quiz-mode.css?v=437'),
  asset('/data.js?v=437'), asset('/data-g1.js?v=437'), asset('/data-g2.js?v=437'), asset('/data-g4.js?v=437'), asset('/data-g5.js?v=437'), asset('/data-g6.js?v=437'), asset('/data-summer.js?v=437'), asset('/data-grammar.js?v=437'),
  asset('/components-shell.jsx?v=437'), asset('/components-quiz.jsx?v=437'),
  asset('/components-flashcard.jsx?v=437'), asset('/components-editor.jsx?v=437'),
  asset('/components-quiz-mode.jsx?v=437'), asset('/components-dashboard.jsx?v=437'),
  asset('/components-mistakes.jsx?v=437'), asset('/styles-mistakes.css?v=437'),
  asset('/styles-theme.css?v=437'), asset('/styles-home.css?v=437'),
  asset('/app.jsx?v=437'), asset('/components-fx.jsx?v=437'),
  asset('/styles-fx.css?v=437'), asset('/styles-tune.css?v=437'),
  asset('/summer-booking.html'), asset('/summer-booking.css?v=437'), asset('/summer-booking-admin.css?v=437'), asset('/summer-booking.js?v=437'),
];
