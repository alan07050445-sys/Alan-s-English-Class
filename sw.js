...
const CACHE = 'alans-english-v398';
...
// 跟版本走的檔案：URL 上都帶 ?v=398，所以 cache-first 是安全的（改版就換 URL）。
const PRECACHE = [
  asset('/'), asset('/index.html'), asset('/manifest.json?v=398'),
  asset('/styles.css?v=398'), asset('/styles-part2.css?v=398'), asset('/styles-quiz.css?v=398'),
  asset('/styles-flashcard.css?v=398'), asset('/styles-auth.css?v=398'), asset('/styles-quiz-mode.css?v=398'),
  asset('/data.js?v=398'), asset('/data-g2.js?v=398'), asset('/data-g4.js?v=398'), asset('/data-g5.js?v=398'), asset('/data-g6.js?v=398'), asset('/data-summer.js?v=398'), asset('/data-grammar.js?v=398'),
  asset('/components-shell.jsx?v=398'), asset('/components-quiz.jsx?v=398'),
  asset('/components-flashcard.jsx?v=398'), asset('/components-editor.jsx?v=398'),
  asset('/components-quiz-mode.jsx?v=398'), asset('/components-dashboard.jsx?v=398'),
  asset('/components-mistakes.jsx?v=398'), asset('/styles-mistakes.css?v=398'),
  asset('/styles-theme.css?v=398'), asset('/styles-home.css?v=398'),
  asset('/app.jsx?v=398'), asset('/components-fx.jsx?v=398'),
  asset('/styles-fx.css?v=398'), asset('/styles-tune.css?v=398'),
  asset('/summer-booking.html'), asset('/summer-booking.css?v=398'), asset('/summer-booking-admin.css?v=398'), asset('/summer-booking.js?v=398'),
];
