...
const CACHE = 'alans-english-v394';
...
// 跟版本走的檔案：URL 上都帶 ?v=394，所以 cache-first 是安全的（改版就換 URL）。
const PRECACHE = [
  asset('/'), asset('/index.html'), asset('/manifest.json?v=394'),
  asset('/styles.css?v=394'), asset('/styles-part2.css?v=394'), asset('/styles-quiz.css?v=394'),
  asset('/styles-flashcard.css?v=394'), asset('/styles-auth.css?v=394'), asset('/styles-quiz-mode.css?v=394'),
  asset('/data.js?v=394'), asset('/data-g2.js?v=394'), asset('/data-g4.js?v=394'), asset('/data-g5.js?v=394'), asset('/data-g6.js?v=394'), asset('/data-summer.js?v=394'), asset('/data-grammar.js?v=394'),
  asset('/components-shell.jsx?v=394'), asset('/components-quiz.jsx?v=394'),
  asset('/components-flashcard.jsx?v=394'), asset('/components-editor.jsx?v=394'),
  asset('/components-quiz-mode.jsx?v=394'), asset('/components-dashboard.jsx?v=394'),
  asset('/components-mistakes.jsx?v=394'), asset('/styles-mistakes.css?v=394'),
  asset('/styles-theme.css?v=394'), asset('/styles-home.css?v=394'),
  asset('/app.jsx?v=394'), asset('/components-fx.jsx?v=394'),
  asset('/styles-fx.css?v=394'), asset('/styles-tune.css?v=394'),
  asset('/summer-booking.html'), asset('/summer-booking.css?v=394'), asset('/summer-booking-admin.css?v=394'), asset('/summer-booking.js?v=394'),
];
