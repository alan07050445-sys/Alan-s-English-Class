...
const CACHE = 'alans-english-v397';
...
// 跟版本走的檔案：URL 上都帶 ?v=397，所以 cache-first 是安全的（改版就換 URL）。
const PRECACHE = [
  asset('/'), asset('/index.html'), asset('/manifest.json?v=397'),
  asset('/styles.css?v=397'), asset('/styles-part2.css?v=397'), asset('/styles-quiz.css?v=397'),
  asset('/styles-flashcard.css?v=397'), asset('/styles-auth.css?v=397'), asset('/styles-quiz-mode.css?v=397'),
  asset('/data.js?v=397'), asset('/data-g2.js?v=397'), asset('/data-g4.js?v=397'), asset('/data-g5.js?v=397'), asset('/data-g6.js?v=397'), asset('/data-summer.js?v=397'), asset('/data-grammar.js?v=397'),
  asset('/components-shell.jsx?v=397'), asset('/components-quiz.jsx?v=397'),
  asset('/components-flashcard.jsx?v=397'), asset('/components-editor.jsx?v=397'),
  asset('/components-quiz-mode.jsx?v=397'), asset('/components-dashboard.jsx?v=397'),
  asset('/components-mistakes.jsx?v=397'), asset('/styles-mistakes.css?v=397'),
  asset('/styles-theme.css?v=397'), asset('/styles-home.css?v=397'),
  asset('/app.jsx?v=397'), asset('/components-fx.jsx?v=397'),
  asset('/styles-fx.css?v=397'), asset('/styles-tune.css?v=397'),
  asset('/summer-booking.html'), asset('/summer-booking.css?v=397'), asset('/summer-booking-admin.css?v=397'), asset('/summer-booking.js?v=397'),
];
