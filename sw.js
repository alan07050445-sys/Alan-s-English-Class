...
const CACHE = 'alans-english-v404';
...
// 跟版本走的檔案：URL 上都帶 ?v=404，所以 cache-first 是安全的（改版就換 URL）。
const PRECACHE = [
  asset('/'), asset('/index.html'), asset('/manifest.json?v=404'),
  asset('/styles.css?v=404'), asset('/styles-part2.css?v=404'), asset('/styles-quiz.css?v=404'),
  asset('/styles-flashcard.css?v=404'), asset('/styles-auth.css?v=404'), asset('/styles-quiz-mode.css?v=404'),
  asset('/data.js?v=404'), asset('/data-g1.js?v=404'), asset('/data-g2.js?v=404'), asset('/data-g4.js?v=404'), asset('/data-g5.js?v=404'), asset('/data-g6.js?v=404'), asset('/data-summer.js?v=404'), asset('/data-grammar.js?v=404'),
  asset('/components-shell.jsx?v=404'), asset('/components-quiz.jsx?v=404'),
  asset('/components-flashcard.jsx?v=404'), asset('/components-editor.jsx?v=404'),
  asset('/components-quiz-mode.jsx?v=404'), asset('/components-dashboard.jsx?v=404'),
  asset('/components-mistakes.jsx?v=404'), asset('/styles-mistakes.css?v=404'),
  asset('/styles-theme.css?v=404'), asset('/styles-home.css?v=404'),
  asset('/app.jsx?v=404'), asset('/components-fx.jsx?v=404'),
  asset('/styles-fx.css?v=404'), asset('/styles-tune.css?v=404'),
  asset('/summer-booking.html'), asset('/summer-booking.css?v=404'), asset('/summer-booking-admin.css?v=404'), asset('/summer-booking.js?v=404'),
];
