...
const CACHE = 'alans-english-v441';
...
// 跟版本走的檔案：URL 上都帶 ?v=441，所以 cache-first 是安全的（改版就換 URL）。
const PRECACHE = [
  asset('/'), asset('/index.html'), asset('/manifest.json?v=441'),
  asset('/styles.css?v=441'), asset('/styles-part2.css?v=441'), asset('/styles-quiz.css?v=441'),
  asset('/styles-flashcard.css?v=441'), asset('/styles-auth.css?v=441'), asset('/styles-quiz-mode.css?v=441'),
  asset('/data.js?v=441'), asset('/data-g1.js?v=441'), asset('/data-g2.js?v=441'), asset('/data-g4.js?v=441'), asset('/data-g5.js?v=441'), asset('/data-g6.js?v=441'), asset('/data-summer.js?v=441'), asset('/data-grammar.js?v=441'),
  asset('/components-shell.jsx?v=441'), asset('/components-quiz.jsx?v=441'),
  asset('/components-flashcard.jsx?v=441'), asset('/components-editor.jsx?v=441'),
  asset('/components-quiz-mode.jsx?v=441'), asset('/components-dashboard.jsx?v=441'),
  asset('/components-mistakes.jsx?v=441'), asset('/styles-mistakes.css?v=441'),
  asset('/styles-theme.css?v=441'), asset('/styles-home.css?v=441'),
  asset('/app.jsx?v=441'), asset('/components-fx.jsx?v=441'),
  asset('/styles-fx.css?v=441'), asset('/styles-tune.css?v=441'),
  asset('/summer-booking.html'), asset('/summer-booking.css?v=441'), asset('/summer-booking-admin.css?v=441'), asset('/summer-booking.js?v=441'),
];
